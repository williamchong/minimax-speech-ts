...
export const API_PATH_FILE_LIST = '/v1/files/list'
export const API_PATH_FILE_RETRIEVE = '/v1/files/retrieve'
export const API_PATH_FILE_RETRIEVE_CONTENT = '/v1/files/retrieve_content'
export const API_PATH_FILE_DELETE = '/v1/files/delete'
